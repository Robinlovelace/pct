...
such as the 'friction of distance' and the 'gravity law' (described in the
subsequent section). 
...
A resergence of interest in the distance-frequency relationship seeks
questions the validity of simple pre-existing
...
Clearly this equation can be refined. 
...
## Alternative terms for distance decay
...
and 'the gravity law'. It is worth reviewing these terms before describing
...
'friction of distance' [@Ellegard2004], which explains
*why* 'near things are more related than distance things'.
However, the question of precisely *how* this friction increases
with distance has not been tackled by researchers using the term.

The 'gravity law' of movement patterns
helped to quantify and generalise early incarnations if *dd* [@zipf1946p1].
This 'law' (also referred to as the 'gravity model')
...
# Key features of distance decay functions
