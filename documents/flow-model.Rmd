...
$SLC(gendereq)_f$ is number of females cycling in the gender equality senario, and
$tflow_m$ and $tflow_f$ are the total numbers of males
and females in the flow respectivly.
...
This allows us to estiamte the number of males cycling as $olc_m = olc * pcycle_m$,
so that
$$
