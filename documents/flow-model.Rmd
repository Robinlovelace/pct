---
title: The National Propensity to Cycle Tool: A generalisable flow-level model of cycling uptake for sustainable transport planning
...
implies that the total increase in the proportion of cyclists in this distance band is 5.0% - i.e. $pcycle(nmod) = 5.0%$.   In the case study city of Manchester, the proportion of commuters travelling 4 to 5 km to work,
...
becomes equal to the observed proportion of males cycling ($pcycle_m$).
...
where $OLC_m$ is the observed number of males cycling
