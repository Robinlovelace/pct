...
the proportion of trips made by bicycle per flow ($pcycle$). Central to the
...
$$
pcycle \approx \frac{exp(\alpha + \beta_1 X1 + \beta_2 X1 + \beta3_ X2)}{exp(\alpha + \beta_1 X1 + \beta_2 X1 + \beta_3 X2) + 1}
$$

where $X1$ is distance (km, route distance), $X2$ is the hilliness
(described below) per flow and
$\alpha$ and $\beta$ symbols represent parameters to be estimated.
