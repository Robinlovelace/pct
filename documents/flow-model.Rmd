...
level of cycling. The Cycling Delivery Plan scenario translates this doubling into a change
in cycling at an individual flow level. Specifically, the future rate of
...
Flow data is generally provided as a 'flow matrix' (with rows representing origins
...
in R. Note also the origin and destination codes in some rows
