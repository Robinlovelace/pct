...
Table \ref{tbl:flow}, Table \ref{tbl:cents} and Fig. 1 illustrate the two input datasets along with the
...
text file
of flows between unique origin destination pairs, disaggregated by mode (see Table \ref{tbl:cents}).
...
The formula choose to model the data with was:
