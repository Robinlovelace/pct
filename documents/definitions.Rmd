...
## Concepts and measures of cycling we may want to discuss, calculate and present

- **Current level of cycling** refers to the amount of current cycling activity.
...
- **Potential level of cycling** (*PC*)
  ...
  This potential level is calculated using a model and can 
