...
5 km in each LAD is illustrate in Fig. 2.
...
Each of these local authorities are represented by an 'x' in
Fig. x.
...
are:  Lancashire,                Hampshire,                   
Kent,                         Essex,                       
Birmingham,                   Hertfordshire,               
Surrey,                       Leeds,                       
Staffordshire and               Nottinghamshire.
 
Note that the absolute size of these CUAs plays a strong role in
...
CUAs, by contrast, is 170,000. These numbers underline the importance
...
The addition of these explanatory variables should improve the predictive
...
scenarios of the future. An additional extension of this national-level
...
estimates of the future level of cycling under each of the afforementioned
