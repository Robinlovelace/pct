...
```{r, echo=FALSE}
if(!exists("la"))
  la <- "Blackpool" # create default LA name if none exists
```
...
# if(grepl(pattern = "Coventry", x = la) > 0){
...
if(file.exists(paste0("pct-data/", la, "/rf_ttwa.Rds"))){
  ...
  # see ?gLine2CyclePath from stplanr package
