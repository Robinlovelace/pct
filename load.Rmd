...
dir.create(paste0("../pct-shiny/", la))
from <- list.files("../pct-shiny/coventry", full.names = T)
file.copy(from = from, to = paste0("../pct-shiny/", la))
server_text <- readLines(paste0("../pct-shiny/", la, "/server.R"))
server_text <- gsub(pattern = "coventry", replacement = la, x = server_text)
writeLines(server_text, con = paste0("../pct-shiny/", la, "/server.R"))
system(paste0("cp -r ../pct-shiny/coventry/www ../pct-shiny/", la))
```
