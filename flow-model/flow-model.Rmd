...
These were: 'Government Target', in which the rate of cycling doubles;
...
operate a slightly different geography than the more commonly used
LAD divisions (Fig. 2).
...
- Government target (*govtarget*). Under this scenario the level of cycling doubles.
This scenario represents a near-term vision:
...
The Government Target scenario (*govtarget*) is based on the government's
