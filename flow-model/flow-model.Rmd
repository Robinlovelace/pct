...
constraints were reduced or removed.  Although not explicitly represented in the model,
...
that would result if females cycled as much as men, all things being equal.
...
In places where cycling is the norm,
cycle as much as men (Pucher et al 2010), so *gendereq* represents
the elimination of one specific cultural constraint.
This scenario has greatest impact in areas where
the rate of cycling is low and highly unequal (Fig. 4)
and along desire lines where cycling
...
scenario, cycling does not double in all areas.
In zones that have high average
commute distances or a high observed rate of cycling, cycling will increase
by less than double. In zones with a below average
current rate of cycling but high potential based on
trip distance distributions
cycling will more than double. In all cases the rate of cycling
increases.
...
and well targetted infrastructure interventions as part of a wider shifts in
