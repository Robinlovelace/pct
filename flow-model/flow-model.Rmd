...
Mounting evidence about the external costs associated with car-dominated
...
[@Geertman2009]. As with previously documented online systems [e.g. @CPE:CPE3282],
the PCT
...
continous time [@Behrisch2014;@Krajzewicz2014], the PCT is based on static
'snapshot' scenarios of plausible future states.

The PCT is based on aggregate-level data, making it scalable
to the national level on a desktop computer.
The PCT's use of O-D data enables it to estimate cycling potential at
