...
Increased cycling, as part of a wider sustainable mobility strategy, is an
increasingly common objective in transport planning institutions worldwide.
Emerging evidence illustrates that good cycling infrastructure
is an effective way of promoting cycling. The fact that cycling infrastructure
is highly localised means that
there are many available options to choose from when planning, for example,
new cycle paths. If new paths coincide with the areas and 'desire lines'
of greatest latent demand, they will be highly cost-effective. Some paths,
however, are constructed along corridors with little latent demand
and have poor benefit-cost ratios. The National Propensity to Cycle Tool (NPCT)
tackles this issue at the policy development stage by providing an
...
to explains how its open source code base
can easily be used in new contexts. It was found that there is high demand
for the NPCT to assist the decision making process around new transport
infrastructure. We conclude that the method presented has the potential to
assist with planning for cycling-dominated cities worldwide, which can help
...
[@Pettit2013]. The NPCT differs from previous work, however, in its focus
...
model to be reconstructed by others. The NPCT is also, to the authors' knowledge,
the first PSS to be developed that is focused on cycling.
Uniquely, the NPCT provides a framework for
developing various scenarios of cycling update at the local and 
route level in response to achieving national, regional or city-wide targets.
...
This paper describes the 'flow-level' model underlying the
