...
- Focus on future scenarios of active travel.
- Estimation and visualisation of information at
the zone and 'desire line' level.
- Route-allocation of flows, enabling specific routes to be identified
for improvement.
...
We also included hilliness as an
...
per flow. The remaining values are scalar
...
of area. Note that *pcycle* was used instead of the total number of commuter
cyclists as the dependent variable because it's
large variations in the absolute flow by all modes.
