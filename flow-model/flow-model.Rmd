...
particular zones rather than OD pairs). @Parkin2008, for example, used
...
The results for each scenario are pre-calculated,
rather than being computed 'on the fly' to create a responsive
user interface.  To ensure the model is accessible, the
user is not required to specify any numerical model parameters to interact with
the PCT. Furthermore, the PCT's open source approach reduces two additional barriers to
...
We used the Census 2011 travel to work dataset
