...
zones would be selected outside the city's long and thin area (see Fig. 7 below).
...
that would result if females cycled as much as men, all other variables being equal.
...
commuter trips in each area which are of cyclable length (i.e. typically less
than around 5 miles) and the proportion of trips which are already made by cycling.
...
for Health Research, and the Wellcome Trust. AG’s contribution was
supported by a National Institute for Health Research (NIHR) post-doctoral
...
the Department for Health.  DfT staff contributed to the design of the
PCT by offering feedback during user testing sessions.  Otherwise, none of
the funders played any role in the design and development of the PCT, in
the interpretation of its outputs, in the writing or this report, or the
