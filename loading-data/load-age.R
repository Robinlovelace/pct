...
unzip("/media/robin/data/data-to-add/wp7102ew_msoa-distance-ttw-age.zip", exdir = "bigdata/")
...
unzip("/media/robin/data/data-to-add/wp7101ew_msoa-method-ttw-age.zip", exdir = "bigdata/")

av <- read.csv("bigdata/wp7102ew_msoa/WP7102EWDATA.CSV", stringsAsFactors = F)
names(av)
...
head(av)
summary(av)
write.csv(av, "bigdata/wp7102ew_msoa/perc_short_young.csv")
