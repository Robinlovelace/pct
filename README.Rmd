...
This repository allows users to estimate the potential
for cycling to grow at the local level. Specifically,
it allows estimation of the cycling potential between
different origin-destination pairs under different
scenarios.
